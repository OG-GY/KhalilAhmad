  ...
  return (
    ...
    >
      <div className="mx-auto max-w-7xl">
        ...
        >
          <h2 id="tech-stack-title" className="text-4xl font-bold tracking-tight lg:text-6xl">
            {title}
          </h2>
        ...
        >
          <TechTabs categories={categories} activeCategory={activeCategory} onCategoryChange={setActiveCategory} />
        </motion.div>
        ...
        >
          <p className="text-sm text-zinc-400">
            ...
            {activeCategory !== "All" && <span className="ml-1 text-yellow-600">in {activeCategory}</span>}
          </p>
        </motion.div>
      </div>
    </section>
